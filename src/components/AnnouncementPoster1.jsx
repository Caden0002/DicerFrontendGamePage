...
import backgroundImage from '/AnnouncementConnectBackground.png';

const header1 = "Let's connect";
const header2 = "Follow us on social media";
const buttonText = "X";

export default function AnnouncementPoster1() {
      const wrapperStyle = {
